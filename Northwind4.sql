...
CREATE DATABASE IF NOT EXISTS Northwind4;
USE Northwind4;
...
CREATE TABLE Quotations (
    QuotationID INTEGER PRIMARY KEY AUTO_INCREMENT,
    CustomerID INTEGER,
...
CREATE TABLE QuotationDetails (
    QuotationDetailID INTEGER PRIMARY KEY AUTO_INCREMENT,
    QuotationID INTEGER,
    ProductID INTEGER,
    Quantity INTEGER,
...
SELECT * FROM Quotations WHERE QuotationID = 2;
...
ADD EstadoID INT,  
ADD CONSTRAINT FK_Quotations_Estado FOREIGN KEY (EstadoID) REFERENCES Estado(EstadoID);
...
INSERT INTO Estado  VALUES (7, 'Cancelado');
INSERT INTO Estado  VALUES (8, 'Finalizado');
INSERT INTO Estado  VALUES (9, 'Suspendido');
INSERT INTO Estado  VALUES (10, 'Expirado');

select * from quotationdetails;
-- Cotización 1
INSERT INTO Quotations (CustomerID, QuotationDate, EstadoID)
VALUES (1, '2025-02-19 10:30:00', 4);

INSERT INTO Quotations (CustomerID, QuotationDate, EstadoID) 
VALUES (2, '2025-02-20 14:15:00', 3 );

INSERT INTO Quotations (CustomerID, QuotationDate, EstadoID)
VALUES (3, '2025-02-21 09:45:00' , 5);

INSERT INTO Quotations (CustomerID, QuotationDate, EstadoID)
VALUES (4, '2025-02-22 16:00:00' , 1);

INSERT INTO Quotations (CustomerID, QuotationDate, EstadoID)
VALUES (5, '2025-02-23 11:20:00' , 1);

INSERT INTO QuotationDetails (QuotationID, ProductID, Quantity) VALUES (6, 2, 5);
INSERT INTO QuotationDetails (QuotationID, ProductID, Quantity) VALUES (7, 3, 10);
INSERT INTO QuotationDetails (QuotationID, ProductID, Quantity) VALUES (8, 4, 7);
INSERT INTO QuotationDetails (QuotationID, ProductID, Quantity) VALUES (9, 1, 15);
INSERT INTO QuotationDetails (QuotationID, ProductID, Quantity) VALUES (3, 2, 5);
SELECT * FROM quotations;

INSERT INTO Quotations (quotationID, customerID, QuotationDate, EstadoID)  
VALUES (3,1, '2025-02-21 09:45:00',5);
...
SELECT  
    ...
    (SUM(OrderDetails.Quantity * Products.Price) OVER (PARTITION BY Orders.OrderID)) AS TotalFactura
FROM Customers  
...
WHERE Customers.CustomerID = 64;
  -- Esto lo hice para hacer mas dinamico la busqueda de orden
SHOW TABLES;
...
set @quotationID = 1; 
SELECT  
    Quotations.QuotationID AS CotizacionID, 
    Quotations.QuotationDate AS FechaCotizacion,
    Customers.CustomerName AS Cliente,
    Products.ProductName AS Producto,
    QuotationDetails.Quantity AS Cantidad,
    Products.Price AS PrecioUnitario,
    Estado.type AS Estado,
    (QuotationDetails.Quantity * Products.Price) AS TotalProducto,
    (SELECT SUM(QuotationDetails2.Quantity * Products2.Price)  
     FROM QuotationDetails QuotationDetails2  
     JOIN Products Products2 ON QuotationDetails2.ProductID = Products2.ProductID  
     WHERE QuotationDetails2.QuotationID = Quotations.QuotationID) AS TotalCotizacion,
     Estado.type AS Estado
FROM Quotations  
JOIN Estado on Quotations.EstadoID = Estado.EstadoID
JOIN Customers ON Quotations.CustomerID = Customers.CustomerID  
JOIN QuotationDetails ON Quotations.QuotationID = QuotationDetails.QuotationID  
JOIN Products ON QuotationDetails.ProductID = Products.ProductID  
WHERE Customers.customerID = @quotationID;
